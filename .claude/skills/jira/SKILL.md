---
name: jira
description: Comprehensive management of Atlassian Jira and Confluence resources, enforcing project scope (FastDeck, Key: FAS), platform prefixes, labeling standards, and issue templates.
trigger: /jira
---

# Jira & Confluence Management Ruleset

This ruleset defines the standard patterns for interacting with Atlassian resources. **All operations MUST target the FastDeck environment.**

## 1. Target Environment

- **Jira Project Name:** `FastDeck`
- **Jira Project Key:** `FAS`
- **Confluence Space Key:** `FAS` (FastDeck)
- **Cloud Instance:** `ar1603.atlassian.net`

> [!IMPORTANT]
> Every Jira issue created or modified MUST use `projectKey: "FAS"`.
> Every Confluence page created or searched MUST use `spaceId: "FAS"` or `spaceKey: "FAS"`.
...
- **FAS-1**: `[Core] Infrastructure & Modernization`
- **FAS-2**: `[Web] Web App Features`
- **FAS-3**: `[Design] Visual Excellence`
- **FAS-4**: `[Localization] Localization & Accessibility`
- **FAS-5**: `[Desktop] Desktop Core Experience & Platform Distribution`
- **FAS-6**: `[Mobile] Mobile Core Experience & Platform Distribution`
