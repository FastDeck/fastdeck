...
This skill defines the standards for creating, updating, and formatting README files across the FastDeck repository. Maintaining clean, technically accurate, and easily readable documentation ensures developers and agents can quickly understand the system's architecture, dependencies, and entry points.
...
- Must start with a clear H1 representing the module name: `# FastDeck [Module] (folder/)`
