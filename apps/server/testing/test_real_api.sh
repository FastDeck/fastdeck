#!/usr/bin/env bash
# =============================================================================
# test_real_api.sh — Comprehensive API Test Suite for AudioMesh Backend
#
...
clear
echo -e "${BOLD}====================================================${RESET}"
echo -e "${BOLD}       AudioMesh Real Mode API Test Tool         ${RESET}"
echo -e "${BOLD}====================================================${RESET}"
...
echo -n "AudioMesh file upload content - $(date) - $((RANDOM))" > "$temp_upload_file"
